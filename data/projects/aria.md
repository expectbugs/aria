...
## Status
Phase 4 in progress (v0.4.13). Fitbit, nutrition labels, and Whisper STT complete. Context builder upgrade in progress (tiered injection, D4 fix). Swarm architecture next.
...
- 614 automated tests (unit + integration)
